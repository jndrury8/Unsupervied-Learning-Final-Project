...
# Finding datatypes and shapes of the data we are working with and removing outliers (outlier detection code removed because no outliers were detected). There will be further visualizations later in the notebook.
...
# https://github.com/jndrury8/Unsupervied-Learning-Final-Project.git
